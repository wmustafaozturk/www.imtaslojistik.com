<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Menu.aspx.vb" Inherits="DokumanYonetimi.Menu" %>
...
<body>
     ...
     <div class="container">
			...
			<ul id="gn-menu" class="gn-menu-main">
                ...
                <li><a class="codrops-icon " href="users.aspx">KULLANICI EKLE</a></li>
                <li><a class="codrops-icon " href="evraklar.aspx">EVRAK EKLE</a></li> 
                <li><a class="codrops-icon " href="HaberGiris.aspx">HABER EKLE</a></li>   
